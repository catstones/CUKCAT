...
const about = [
  {
    ...
    members: [
      { name: "한영찬", role: "Frontend" },
      { name: "안수빈", role: "Backend" },
      { name: "박진우", role: "Backend" },
      { name: "백상우", role: "ProjectManager" },
    ],
  },
  {
    version: "가대학사",
    members: [
      { name: "권세훈", role: "FrontDesigner" },
      { name: "백상우", role: "FullStack" },
    ],
  },
];

export { listedHaksa, about, markedHaksa };
